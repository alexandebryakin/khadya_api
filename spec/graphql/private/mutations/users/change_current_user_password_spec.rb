...
RSpec.describe Private::Mutations::Users::ChangeCurrentUserPassword, type: :request do
  subject(:run_mutation) { Private::KhadyaApiSchema.execute(query, variables:, context: { current_user: user }) }
