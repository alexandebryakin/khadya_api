...
RSpec.describe Private::Queries::Users::GetUser, type: :request do
  subject(:run_query) { Private::KhadyaApiSchema.execute(query, variables:, context: { current_user: user }) }
